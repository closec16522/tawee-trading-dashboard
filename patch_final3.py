...
pattern = r'if \(meetingLog\)\s*\{[\s\S]*?const msgDiv = document\.createElement\(\'div\'\);[\s\S]*?msgDiv\.innerHTML = \<strong style="color:\$\{data\.color \|\| "#f59e0b"\}">\$\{data\.agent_id\.toUpperCase\(\)\}\<\/strong\>: \$\{txt\};'
